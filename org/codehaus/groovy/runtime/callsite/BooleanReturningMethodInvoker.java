 ...
 * as well as the "asBoolean" in {@link CallSiteArray} fashion. "asBoolean" will
 * not be called if the result is null or a Boolean. In case of null we return
 * false and in case of a Boolean we simply unbox. This logic is designed after
 * the one present in {@link DefaultTypeTransformation#castToBoolean(Object)}.
 * The purpose of this class is to avoid the slow "asBoolean" call in that
 * method.
 * 
