...
inputState.guessing--;
		...
		else if (((_tokenSet_30.member(LA(1))) && (_tokenSet_71.member(LA(2))))&&(addImplicit)) {
			implicitParameters();
			astFactory.addASTChild(currentAST, returnAST);
			closableBlockParamsOpt_AST = (AST)currentAST.root;
		}
		else if ((_tokenSet_30.member(LA(1))) && (_tokenSet_71.member(LA(2)))) {
			closableBlockParamsOpt_AST = (AST)currentAST.root;
		}
		else {
			throw new NoViableAltException(LT(1), getFilename());
 ...
 */
	...
	public final void relationalExpression(
		...
		else if ((LA(1)==LITERAL_instanceof) && (_tokenSet_98.member(LA(2)))) {
			AST tmp296_AST = null;
		...
		else if ((LA(1)==LITERAL_as) && (_tokenSet_98.member(LA(2)))) {
			AST tmp297_AST = null;
	...
	public final void multiplicativeExpression(
		...
		case MINUS:
		{
			...
			match(MINUS);
			if ( inputState.guessing==0 ) {
				tmp308_AST.setType(UNARY_MINUS);
			}
			nls();
			powerExpressionNotPlusMinus(0);
			astFactory.addASTChild(currentAST, returnAST);
...
inputState.guessing--;
				...
				else if ((_tokenSet_87.member(LA(1))) && (_tokenSet_37.member(LA(2)))) {
	...
	public final void postfixExpression(
		...
		astFactory.addASTChild(currentAST, returnAST);
		{
		if ((LA(1)==INC) && (_tokenSet_101.member(LA(2)))) {
			in = LT(1);
		...
		else if ((LA(1)==DEC) && (_tokenSet_101.member(LA(2)))) {
			de = LT(1);
