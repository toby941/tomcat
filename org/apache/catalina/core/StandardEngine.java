...
public class StandardEngine extends ContainerBase implements Engine {
	...
	/**
	 * Allow the base dir to be specified explicitely for each engine. In time
	 * we should stop using catalina.base property - otherwise we loose some
	 * flexibility.
	 */
	private String baseDir = null;

	/**
	 * Optional mbeans config file. This will replace the "hacks" in jk and
	 * ServerListener. The mbeans file will support (transparent) persistence -
	 * soon. It'll probably replace jk2.properties and could replace server.xml.
	 * Of course - the same beans could be loaded and managed by an external
	 * entity - like the embedding app - which can use a different persistence
	 * mechanism.
	 */
