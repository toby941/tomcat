...
public class Request implements HttpServletRequest {
	...
	static {
		...
		ALLOW_EMPTY_QUERY_STRING = Boolean.parseBoolean(System.getProperty(
				"org.apache.catalina.connector.Request.ALLOW_EMPTY_QUERY_STRING", Boolean.toString(Globals.STRICT_SERVLET_COMPLIANCE)));
	}
	...
	public Object getAttribute(String name) {
		...
		if (name.equals(Globals.DISPATCHER_TYPE_ATTR)) {
			return (dispatcherType == null) ? ApplicationFilterFactory.REQUEST_INTEGER : dispatcherType;
	 ...
	 * return will only be those for the attributes set via
	...
	public void changeSessionId(String newSessionId) {
		...
		if (response != null) {
			...
			if (context == null) {
				...
				response.addSessionCookieInternal(newCookie, context.getUseHttpOnly());
			}
		}
	}
