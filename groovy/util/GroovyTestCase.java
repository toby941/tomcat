...
public class GroovyTestCase extends TestCase {
	...
	/**
	 * Overload the getName() method to make the test cases look more like
	 * AgileDox (thanks to Joe Walnes for this tip!)
	 */
	 ...
	 * 
	 * @param expected
	 *            expected character to be found
	 * @param array
	 *            the array
	 */
	 ...
	 * 
	 * @param value
	 *            the object to be output to the console
	 * @param expected
	...
	/**
	 * Asserts that the value of inspect() on the given object matches the given
	 * text string
	 * 
	 * @param value
	 *            the object to be output to the console
	 ...
	 * </pre>
	 * 
	 * Idea copied from HtmlUnit (many thanks to Marc Guillemot). Future
	 * versions maybe available in the JUnit distro. The purpose of providing a
	 * 'static' version is such that you can use the feature even if not
	 * subclassing GroovyTestCase.
	 * 
