 ...
 * @since 2013年7月29日
 */
public class LimitArrayBlockingQueue<E> extends AbstractQueue<E> implements
	 ...
	 */
	public LimitArrayBlockingQueue(int capacity) {
		this(capacity, false);
	}
	 ...
	 *             if <tt>capacity</tt> is less than 1
	 */
	public LimitArrayBlockingQueue(int capacity, boolean fair) {
		if (capacity <= 0)
	 ...
	 * @return
	 */
	public List<E> poll4List(int size) {
